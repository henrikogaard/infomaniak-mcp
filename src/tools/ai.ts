...
export function registerAITools(server: McpServer, ai: AIService) {
  ...
  server.tool(
    "ai_chat",
    "Send a chat completion request to Infomaniak AI (Euria). Useful for summarization, translation, text processing using sovereign Swiss AI.",
    {
  ...
  server.tool(
    "ai_transcribe",
    "Transcribe audio to text using Infomaniak AI (Whisper). Pass base64-encoded audio content. Works with files downloaded from kDrive.",
    {
